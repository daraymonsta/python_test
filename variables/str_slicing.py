...
hint1_slice = "?" # Create the word slice according to the clue below, use the format "original_word[x:y]"
hint2_slice = "?" # Create the word slice according to the clue below, use the format "original_word[x:y]"
hint3_slice = "?" # Create the word slice according to the clue below, use the format "original_word[x:y]"
hint4_slice = "?" # Create the word slice according to the clue below, use the format "original_word[x:y]"
